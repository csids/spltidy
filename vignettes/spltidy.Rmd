---
title: "Introduction to cstidy"
author: "Richard White"
date: "2022-03-07"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to cstidy}
...
splfmt_rts_data_v1 (`vignette("splfmt_rts_data_v1", package = "cstidy")`) is a data format for real-time surveillance.
...
d[, .(deaths_n = sum(deaths_n), location_code = "norge"), keyby=.(granularity_time)] %>%
  cstidy::remove_class_splfmt_rts_data() %>%
  print()
```
